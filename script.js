...
const image_width = parseFloat(
  window
    .getComputedStyle(slider1.querySelectorAll("img")[0])
    .getPropertyValue("width")
);
const image_margin_right = parseFloat(
  window
    .getComputedStyle(slider1.querySelectorAll("img")[0])
...
const questions = [
  {
    question:
      "What is the only movie from the 1930s to win all five major Academy Awards?",
    answers: [
  ...
  {
    question:
      "What is the only movie that starred both Edward G. Robinson and James Cagney?",
    answers: [
  ...
  {
    question:
      "In 1999, what movie was considered the greatest British film of all time?",
    answers: [
